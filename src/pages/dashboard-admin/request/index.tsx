...
import { attendancedatatest, REQUEST_COLUMNS } from "./columns";
...
const DashboardAdminRequest = () => {
	...
	console.log("useQuery", data?.data.data);
	...
	//react-table addition
	const columns = React.useMemo(() => REQUEST_COLUMNS, []);
	const datatest = React.useMemo(() => attendancedatatest, []);
	return (
		<>
			...
			>
				Test
				<RTable columns={columns} data={datatest} />
			</div>
		</>
	);
};
